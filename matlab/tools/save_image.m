...
switch savemode
   ...
   case 'painters_pdf'
      ...
      % This option of has the problem that it cannot smartly choose the
      % print area.  Get around this by using this lines in your code to
      % choose the area manually:
      %h.PaperPositionMode = 'auto';
      %D = h.PaperPosition;
      %h.PaperPosition     = [0 0 D(3) D(4)];
      %h.PaperSize         = [D(3) D(4)];
